...
import {Avatar, Button, Col,Typography, Layout, Menu, Row} from 'antd';
                ...
                <Col span={8}>
                    <div>
                        {isAuth ? <div>
                                ...
                                <Text type="success"   style={{padding: '15px'}}> {login}</Text>
                                <Button type="primary" onClick={logoutThunkFromHeader}><LogoutOutlined />Logout</Button>
                            </div>
                            :
